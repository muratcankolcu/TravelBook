...
import com.muratcankolcu.travelbook.adapter.PlaceAdapter;
import com.muratcankolcu.travelbook.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = Room.databaseBuilder(MainActivity.this, PlaceDatabase.class, "Places").build();
